...
int main(){
  ...
  /* Gerar(v_b, VETOR_B); */
  /* int tamanho = VETOR_B; */
  /* int target[6] = {0,49999,99999,149999,199999,-1}; */
  /* int encontrou=0; */
  /* int comparacoes = 0; */
  ...
  /* for(int i =0; i<6;i++){ */
  /*   clock_t inicio_sequencial = clock(); */
  /*   encontrou = PesquisaSequencial(v_b, VETOR_B, target[i], &comparacoes); */
  /*   clock_t termino_sequencial = clock(); */
  ...
  /*   clock_t inicio_binaria = clock(); */
  /*   encontrou = PesquisaBinaria(v_b, VETOR_B, target[i], &comparacoes); */
  /*   clock_t termino_binaria = clock(); */
  ...
  Gerar(v_c, VETOR_C);
  int tamanho = VETOR_C;
  int target[6] = {0,74999,149999,224999,299999,-1};
  int encontrou=0;
  int comparacoes = 0;
  ...
  for(int i =0; i<6;i++){
    clock_t inicio_sequencial = clock();
    encontrou = PesquisaSequencial(v_c, VETOR_C, target[i], &comparacoes);
    clock_t termino_sequencial = clock();
  ...
  for(int i =0; i<6;i++){
    ...
    clock_t inicio_binaria = clock();
    encontrou = PesquisaBinaria(v_c, VETOR_C, target[i], &comparacoes);
    clock_t termino_binaria = clock();
